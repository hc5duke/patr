...
//(function () {
flickrPage.doReferrer = function(){
	...
	// Modifications by: Marcos Kuhns (http://www.kuhnsfam.com/)
		...
		resolveGroupName: function(type,groupurl,referrer) {
			...
			var listener = {
				flickr_urls_lookupGroup_onLoad: function(success, responseXML, responseText, params){
                                                    console.log( 'flickr_urls_lookupGroup_onLoad' );
					if(success) {
            ...
            */
			...
			switch(type) {
				...
				case FELLOW:
				case PHOTOPHLOW:
                    chrome.extension.sendRequest( { type: 'xAPI', fn: 'urls.lookupGroup', params: {
                                    url: groupurl,
					...
					//unsafeWindow.F.API.callMethod('flickr.urls.lookupGroup', { url:groupurl }, listener);
			}
		...
		resolveSetName: function(id,referrer,type) {
            ...
            */
            ...
            chrome.extension.sendRequest( { type: 'cAPI', fn: 'photosets.getInfo', params: { photoset_id: id,
                    api_key: flickrPage.api_key,
                    auth_hash: flickrPage.auth_hash,
                    auth_token: '',
                    src: 'js'} 
